...
fun UpdateTransaksiView(
    ...
    val updateTransaksiUiState = viewModel.updateTransaksiUIState
    val coroutineScope = rememberCoroutineScope()
    val scrollBehavior = TopAppBarDefaults.enterAlwaysScrollBehavior()
    val tiketList by viewModel.tiketList.collectAsState() // Ambil data tiket
    ...
    Scaffold(
        ...
        EntryBodyTransaksiUp(
            insertTransaksiUiState = updateTransaksiUiState,
